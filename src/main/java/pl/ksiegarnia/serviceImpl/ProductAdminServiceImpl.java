...
public class ProductAdminServiceImpl implements ProductAdminService {
	...
	public void addImg(MultipartFile file, Book book, String realPatch) throws IOException {
		int idksiazki = repository.getIdFromProduct(book.getImieautora(), book.getNazwiskoautora(), book.getTytul(),
				book.getCena(), book.getIlosc());
